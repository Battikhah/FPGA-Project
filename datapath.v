...
always @(posedge clk or posedge reset) begin
	if (reset || init_ijk) begin
        ...
        if (inc_k) k_count <= k_count + 1'b1;
        if (inc_j) j_count <= j_count + 1'b1;
        if (inc_i) i_count <= i_count + 1'b1;
	end
end
